...
/* package Messer-0.1.0.0 */
#ifndef VERSION_Messer
#define VERSION_Messer "0.1.0.0"
#endif /* VERSION_Messer */
#ifndef MIN_VERSION_Messer
#define MIN_VERSION_Messer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Messer */
...
/* package parser-combinators-1.0.1 */
#ifndef VERSION_parser_combinators
#define VERSION_parser_combinators "1.0.1"
...
#define CURRENT_COMPONENT_ID "Messer-0.1.0.0-Gm7rgtTydiEHjGrkrFaboT-Messer"
