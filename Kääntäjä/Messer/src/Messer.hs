...
-- Tämä on jäsentimen lopullinen "tulos"
...
--lauseke on tässä kielessä sama kuin "statement"
...
--määritelmä on tässä kielessä sama kuin "expression"
...
--Operaattorit on jaoteltu presedenssin mukaan, korkein presedenssi ensimmäisessä listassa
...
--Tämä on itse jäsennin, jota kutsutaan/käytetään kun halutaan jäsentää koko tiedosto
